  ...
  return (
    <Layout>
      ...
      <div className="bg-white">
        <div className="container mx-auto pl-6 pr-6 md:pl-0 md:pr-0 pt-20 pb-20 lg:pr-20 lg:pl-20 lg:pt-40 lg:pb-10">
          <h1 className="mb-12 mt-2 text-6xl text-6xl md:text-8xl leading-tight">
      ...
      <div className="container mx-auto pl-6 pr-6 pb-10 pt-40 pb-40 md:pl-0 md:pr-0 lg:pr-20 lg:pl-20">
        <div className="md:flex md:flex-wrap lg:flex-col lg:relative">
          <div className="md:order-1 md:w-1/2 lg:pr-3">
            ...
            <p className="text-center text-gray-600 pb-6 md:text-left md:pr-10 lg:pb-16">
              If you'd like to get in touch, please leave a message in the quick
              form. Dr Yalda repond to you within two days.
            </p>
          </div>
          <div className="md:w-full md:order-3 lg:absolute lg:w-1/2 lg:top-0 lg:right-0">
            ...
            >
              ...
              <div className="flex flex-wrap -mx-3 mb-6 md:pr-10">
                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0 lg:w-full">
                  ...
                  <input
                    className="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-6 leading-tight focus:outline-none focus:bg-white"
                    id="first-name"
                    name="firstName"
                    type="text"
              ...
              <button
                className="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded w-full px-4 py-4"
                type="submit"
              >
                Submit
              </button>
